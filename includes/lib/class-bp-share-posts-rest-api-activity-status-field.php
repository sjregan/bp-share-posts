...
class BP_Share_Posts_REST_API_Activity_Status_Field {
    ...
    public function __construct() {
        register_rest_field( 'activity', 'bp_share_posts_user_status', [
    ...
    public function get_value( $object, $request ) {
        return BP_Share_Posts()->user_share_activity_status( $object['id'] );
    }
    ...
    public function get_field_schema() {
        return [
            'description' => __( 'Indicates if user has shared activity.', 'bp-share-posts' ),
            'type'        => 'string',
            'context'     => [ 'view' ],
        ];
    }
